...
public class WavefrontMaterial {
    ...
    public internal(set) var ambientMap: Texture2D?
    public internal(set) var diffuseMap: Texture2D?
    public internal(set) var specularMap: Texture2D?
    public internal(set) var specularExponentMap: Texture2D?
    public internal(set) var alphaMap: Texture2D?
    public internal(set) var bumpMap: Texture2D?
    public internal(set) var displacementMap: Texture2D?
    public internal(set) var stencilDecalMap: Texture2D?
}
